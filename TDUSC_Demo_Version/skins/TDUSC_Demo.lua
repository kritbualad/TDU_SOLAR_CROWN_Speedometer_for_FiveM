local skinData = {
	...
	-- gauge locations
	SpeedoBGLoc = {0.087, -0.007, 0.15,0.27},
	SpeedoNeedleLoc = {0.0,-0.000,0.0,0.0}, -- Not Use

	TachoBGloc = {0.087, -0.007, 0.15,0.27},
	TachoNeedleLoc = {0.087, -0.007, 0.15,0.27},
	...
	GearLoc = {0.0873,0.0345,0.009,0.020}, -- gear location
	Speed1Loc = {0.074,-0.008,0.015,0.036}, -- 3rd digit
	Speed2Loc = {0.088,-0.008,0.015,0.036}, -- 2nd digit
	Speed3Loc = {0.102,-0.008,0.015,0.036}, -- 1st digit
