...
local textureTypes = {
	"NeedleTDUSC", "tachometer", "speedometer", "fuelneedle", "fuelgauge","speedometerbg","tachometerbg", "blinker", "engine", "fuel", "lights", "oil", "gear", "kmh", "mph", "digits", "turbo"
}
...
curNeedle, curTachometer, curSpeedometer , curFuelGauge, curAlpha = "NeedleTDUSC", "tachometer_day", "speedometer_day", "fuelgauge_day",0
		...
		if not HasTextureDictLoaded then
			...
			if (DoesCurrentVehExist) then
				...
				if lightson == 1 or highbeams == 1 then
					curNeedle, curTachometer, curSpeedometer , curFuelGauge = "NeedleTDUSC", "tachometer", "speedometer", "fuelgauge"
					if highbeams == 1 then
					...
					curNeedle, curTachometer, curSpeedometer , curFuelGauge, showHighBeams, showLowBeams = "NeedleTDUSC", "tachometer_day", "speedometer_day", "fuelgauge_day", false, false
				end
			...
			if curAlpha ~= 0.0 then
				...
				if MaxFuelLevel ~= 0 then
					...
					DrawSprite(cst.ytdName, OverriddenTextures["NeedleTDUSC"] or cst.Needle or curNeedle, cst.centerCoords[1]+cst.TachoNeedleLoc[1],cst.centerCoords[2]+cst.TachoNeedleLoc[2],cst.TachoNeedleLoc[3],cst.TachoNeedleLoc[4],RPM*(cst.rpmScale)-(cst.rpmScaleDecrease or 0), 255, 255, 255, curAlpha)
				end
				DrawSprite(cst.ytdName, OverriddenTextures["NeedleTDUSC"] or cst.Needle or  curNeedle, cst.centerCoords[1]+cst.SpeedoNeedleLoc[1],cst.centerCoords[2]+cst.SpeedoNeedleLoc[2],cst.SpeedoNeedleLoc[3],cst.SpeedoNeedleLoc[4],-5.00001+degree, 255, 255, 255, curAlpha)
